...
export const AgentProfiles: Record<AgentProfile['id'], AgentProfile> = {
  ...
  'code-fix-executor-agent': {
    id: 'code-fix-executor-agent',
    tier: 'tier2',
    label: 'Code Fix Executor',
    description:
      'Führt Code-Änderungen basierend auf detaillierten AutoFix-Plänen aus. Kann Dateien lesen, modifizieren und schreiben. Universell für alle Kunden-Probleme einsetzbar.',
    goals: [
      'AutoFix-Pläne vollständig analysieren (System-Zustand, Code-Diffs, Kontext)',
      'Code-Änderungen sicher ausführen (mit Backup)',
      'Validierung und Tests durchführen',
      'Rollback bei Fehlern automatisch durchführen',
    ...
    mustUseReverseEngineering: true,
    notes: [
      'Führt Code-Änderungen basierend auf detaillierten AutoFix-Plänen aus',
      'Erstellt immer Backup vor Änderungen',
      'Validiert Änderungen nach Ausführung',
      'Führt automatisch Rollback durch bei Fehlern',
      'Universell für alle Problem-Typen einsetzbar',
    ],
  },
};
